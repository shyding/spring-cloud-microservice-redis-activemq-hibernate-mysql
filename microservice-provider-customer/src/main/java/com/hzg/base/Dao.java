            ...
            if (field.isAnnotationPresent(Column.class) ||
                ...
                if (field.isAnnotationPresent(Type.class)){
                    ...
                    if (returnType.equals("Integer[]")) {
                        ...
                        value = des.decrypt((String)value);
                    }
            ...
            for (Field field : fields) {
                ...
                if (field.isAnnotationPresent(ManyToOne.class) ||
                    ...
                    if (relateObject != null) {
                        List dbRelateObjects =  queryBySql(objectToSql.generateSelectSqlByAnnotation(relateObject), relateObject.getClass());
                        if (dbRelateObjects != null && !dbRelateObjects.isEmpty()) {
                            clazz.getMethod(objectToSql.setMethodPerfix + partMethodName, field.getType()).invoke(object, dbRelateObjects.get(0));
                        }
                ...
                if (field.isAnnotationPresent(ManyToMany.class) ||
                    ...
                    if (relateObjects != null && relateObjects.size() > 0) {
                        for (Object relateObject : relateObjects) {
                            List dbRelateObjects =  queryBySql(objectToSql.generateSelectSqlByAnnotation(relateObject), relateObject.getClass());
                            if (dbRelateObjects != null && !dbRelateObjects.isEmpty()) {
                                relateDbObjects.add(dbRelateObjects.get(0));
                            }
                        }
                    } else {
